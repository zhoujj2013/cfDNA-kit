...
# parser.add_option("--readcount", dest="readcount", help="readcount",default=100000000,type="int")
...
# readcount = float(options.readcount)
# scale = readcount/float(100000000.0)
