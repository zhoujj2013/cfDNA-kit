...
parse.add_argument('-thread',type=int,default=4,help='多线程')
...
#%%
fft_script = '/mnt/dfc_data2/project/linyusen/project/cfDNA_kit/pipeline/WPS/script/fft_path.R'
wps_script = '/mnt/dfc_data2/project/linyusen/project/cfDNA_kit/pipeline/WPS/script/extractReadStartsFromBAM_Region_WPS.py'
concat_fft = '/mnt/dfc_data2/project/linyusen/project/cfDNA_kit/pipeline/WPS/script/concat_fft.py'
concat_wps = '/mnt/dfc_data2/project/linyusen/project/cfDNA_kit/pipeline/WPS/script/concat_wps.py'
entropy_region = '/mnt/dfc_data2/project/linyusen/project/cfDNA_kit/pipeline/WPS/script/entropy_region.py'

rscript_software = '/mnt/dfc_data1/home/linyusen/miniconda/envs/r_env/bin/Rscript'
python27_software = '/mnt/dfc_data1/home/linyusen/miniconda/envs/lys/bin/python'
python38_software = '/mnt/dfc_data1/home/linyusen/miniconda/envs/lys/bin/python'
...
print(fft_save)
cmd = f'{python38_software} {concat_fft} -i {fft_out_dir} -s {fft_save}'
print(cmd)
os.system(cmd)
...
print(wps_save)
cmd = f'{python38_software} {concat_wps} -i {wps_out_dir} -s {wps_save}'
print(cmd)
os.system(cmd)



entropy_save = os.path.join(out_dir,'entropy.pickle')
print(entropy_save)
cmd = f'{python38_software} {entropy_region} -i {wps_save} -s {entropy_save}'
print(cmd)
os.system(cmd)
